...
class GroupApi
{
    ...
    public function createGroupWithHttpInfo($createGroupRequest, string $contentType = self::contentTypes['createGroup'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Kleister\Model\Group' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Kleister\Model\Group' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Kleister\Model\Group', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
    ...
    public function listGroupModsWithHttpInfo($groupId, $search = null, $sort = null, $order = 'asc', $limit = 100, $offset = 0, string $contentType = self::contentTypes['listGroupMods'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Kleister\Model\ListGroupMods200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Kleister\Model\ListGroupMods200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Kleister\Model\ListGroupMods200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 403:
    ...
    public function listGroupPacksWithHttpInfo($groupId, $search = null, $sort = null, $order = 'asc', $limit = 100, $offset = 0, string $contentType = self::contentTypes['listGroupPacks'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Kleister\Model\ListGroupPacks200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Kleister\Model\ListGroupPacks200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Kleister\Model\ListGroupPacks200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 403:
    ...
    public function listGroupUsersWithHttpInfo($groupId, $search = null, $sort = null, $order = 'asc', $limit = 100, $offset = 0, string $contentType = self::contentTypes['listGroupUsers'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Kleister\Model\ListGroupUsers200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Kleister\Model\ListGroupUsers200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Kleister\Model\ListGroupUsers200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 403:
    ...
    public function listGroupsWithHttpInfo($search = null, $sort = null, $order = 'asc', $limit = 100, $offset = 0, string $contentType = self::contentTypes['listGroups'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Kleister\Model\ListGroups200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Kleister\Model\ListGroups200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Kleister\Model\ListGroups200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 403:
