...
class FabricApi
{
     ...
     * @throws \Kleister\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Kleister\Model\InlineObject10|\Kleister\Model\Notification|\Kleister\Model\Notification|\Kleister\Model\Notification
     */
     ...
     * @throws \Kleister\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Kleister\Model\InlineObject10|\Kleister\Model\Notification|\Kleister\Model\Notification|\Kleister\Model\Notification, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\Kleister\Model\InlineObject10';
        $request = $this->listFabricBuildsRequest($fabricId, $search, $sort, $order, $limit, $offset, $contentType);
     ...
     * @throws \Kleister\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Kleister\Model\InlineObject9|\Kleister\Model\Notification|\Kleister\Model\Notification
     */
     ...
     * @throws \Kleister\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Kleister\Model\InlineObject9|\Kleister\Model\Notification|\Kleister\Model\Notification, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\Kleister\Model\InlineObject9';
        $request = $this->listFabricsRequest($search, $contentType);
