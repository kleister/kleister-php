...
class MinecraftApi
{
     ...
     * @throws \Kleister\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Kleister\Model\InlineObject2|\Kleister\Model\Notification|\Kleister\Model\Notification|\Kleister\Model\Notification
     */
     ...
     * @throws \Kleister\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Kleister\Model\InlineObject2|\Kleister\Model\Notification|\Kleister\Model\Notification|\Kleister\Model\Notification, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\Kleister\Model\InlineObject2';
        $request = $this->listMinecraftBuildsRequest($minecraftId, $search, $sort, $order, $limit, $offset, $contentType);
     ...
     * @throws \Kleister\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Kleister\Model\InlineObject1|\Kleister\Model\Notification|\Kleister\Model\Notification
     */
     ...
     * @throws \Kleister\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Kleister\Model\InlineObject1|\Kleister\Model\Notification|\Kleister\Model\Notification, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\Kleister\Model\InlineObject1';
        $request = $this->listMinecraftsRequest($search, $contentType);
