...
class AuthApi
{
     ...
     * @throws \Kleister\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Kleister\Model\InlineObject
     */
     ...
     * @throws \Kleister\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Kleister\Model\InlineObject, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\Kleister\Model\InlineObject';
        $request = $this->listProvidersRequest($contentType);
