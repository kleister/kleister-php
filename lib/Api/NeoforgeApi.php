...
class NeoforgeApi
{
     ...
     * @throws \Kleister\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Kleister\Model\InlineObject6|\Kleister\Model\Notification|\Kleister\Model\Notification|\Kleister\Model\Notification
     */
     ...
     * @throws \Kleister\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Kleister\Model\InlineObject6|\Kleister\Model\Notification|\Kleister\Model\Notification|\Kleister\Model\Notification, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\Kleister\Model\InlineObject6';
        $request = $this->listNeoforgeBuildsRequest($neoforgeId, $search, $sort, $order, $limit, $offset, $contentType);
     ...
     * @throws \Kleister\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Kleister\Model\InlineObject5|\Kleister\Model\Notification|\Kleister\Model\Notification
     */
     ...
     * @throws \Kleister\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Kleister\Model\InlineObject5|\Kleister\Model\Notification|\Kleister\Model\Notification, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\Kleister\Model\InlineObject5';
        $request = $this->listNeoforgesRequest($search, $contentType);
