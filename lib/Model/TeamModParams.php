...
/**
 * TeamModParams Class Doc Comment
 *
 * @category Class
 * @package  Kleister
 * @author   OpenAPI Generator team
 ...
 */
class TeamModParams implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'team_mod_params';
    ...
    {
        $this->container['mod'] = $data['mod'] ?? null;
