...
class ValidationError implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'status' => 'int',
        'message' => 'string',
        'errors' => '\Kleister\Model\ValidationErrorErrors[]'
    ];
     ...
     * Gets errors
     *
     * @return \Kleister\Model\ValidationErrorErrors[]|null
     */
     ...
     * Sets errors
     *
     * @param \Kleister\Model\ValidationErrorErrors[]|null $errors errors
     *
     * @return $this
     */
