...
class Build implements ModelInterface, ArrayAccess
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['packId'] = isset($data['packId']) ? $data['packId'] : null;
        $this->container['minecraftId'] = isset($data['minecraftId']) ? $data['minecraftId'] : null;
        $this->container['forgeId'] = isset($data['forgeId']) ? $data['forgeId'] : null;
        $this->container['slug'] = isset($data['slug']) ? $data['slug'] : null;
        $this->container['name'] = isset($data['name']) ? $data['name'] : null;
        $this->container['minJava'] = isset($data['minJava']) ? $data['minJava'] : null;
        $this->container['minMemory'] = isset($data['minMemory']) ? $data['minMemory'] : null;
